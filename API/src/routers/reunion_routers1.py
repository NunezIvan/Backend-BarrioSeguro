...
#Crear una reunion
@reunion1_router.post('/reunion',status_code=HTTP_201_CREATED,tags=['Reunion'])
...
@reunion1_router.get('/reunion/{id_asociacion}',response_model=List[reunion],tags=['Reunion'])
...
@reunion1_router.get('/reunion/pendiente/{id_asociacion}',response_model=List[reunion],tags=['Reunion'])
...
@reunion1_router.get('/reunion/realizada/{id_asociacion}',response_model=List[reunion],tags=['Reunion'])
...
@reunion1_router.put('/reunion/{id_reunion}', tags=['Reunion'],response_model=act_reu)
...
@reunion1_router.delete('/reunion/{id_reunion}',tags=['Reunion'],status_code=HTTP_204_NO_CONTENT)
