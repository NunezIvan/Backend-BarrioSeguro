...
# Crear una encuesta
@encuesta1_router.post('/encuesta', status_code=HTTP_201_CREATED, tags=['Encuesta'], dependencies=[Depends(get_api_key)])
...
# Mostrar lista de encuestas de una asociacion
@encuesta1_router.get('/encuesta/{id_asociacion}', response_model=List[encuesta_asoc], tags=['Encuesta'], dependencies=[Depends(get_api_key)])
...
@encuesta1_router.put('/encuesta/{id_encuesta}', tags=['Encuesta'], response_model=updt_encuesta, dependencies=[Depends(get_api_key)])
...
@encuesta1_router.delete('/encuesta/{id_encuesta}', tags=['Encuesta'], status_code=HTTP_204_NO_CONTENT, dependencies=[Depends(get_api_key)])
