...
@seguridad1_router.post('/seguridad',status_code=HTTP_201_CREATED,tags=['Seguridad'])
...
@seguridad1_router.get('/seguridad',tags=['Seguridad'],response_model=List[seguridad])
...
@seguridad1_router.get('/seguridad/{id_asociacion}',response_model=List[seguridad],tags=['Seguridad'])
...
@seguridad1_router.put('/seguridad/{vecino_dni}', tags=['Seguridad'],response_model=update_sec)
...
@seguridad1_router.delete('/seguridad/{vecino_dni}',tags=['Seguridad'],status_code=HTTP_204_NO_CONTENT)
